...
-- |Get the number of bytes from a string
getBytes :: B.ByteString -> String
getBytes = show . B.length

-- |Get the number of lines from a string
...
-- |Get the number of characters from a string
getChars :: B.ByteString -> String
getChars = show . T.length . E.decodeUtf8

-- |Get the default option which is bytes, lines, and words
